...
// url to retrieve the feeds from Hollywood reporter for movies
var feedurl = "http://feeds.feedburner.com/thr/film"
var feedlimit = 10
...
function displayfeed(result) {
    ...
    // 10 times and are displayed on the movie news feed page
    if (!result.error) {
