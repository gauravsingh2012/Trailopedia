...
function getNextPage() {
    ...
    $.ajax({
        url: "https://api.themoviedb.org/3/movie/popular?api_key=052ca14131fc2be845560a604c66ffd5&page=" + nextPageNumber,
        crossDomain: true,
        dataType: "jsonp",
...
function getPreviousPage() {
    ...
    $.ajax({
        url: "https://api.themoviedb.org/3/movie/popular?api_key=052ca14131fc2be845560a604c66ffd5&page=" + previousPageNumber,
        crossDomain: true,
        dataType: "jsonp",
        jsonpCallback: 'myRoviCallBack',
        success: function (data) {
...
// fetches the popular movies from movie db
$(document).ready(function () {
    $.ajax({
        url: "https://api.themoviedb.org/3/movie/popular?api_key=052ca14131fc2be845560a604c66ffd5",
        crossDomain: true,
        dataType: "jsonp",
        jsonpCallback: 'myRoviCallBack',
        success: function (data) {
