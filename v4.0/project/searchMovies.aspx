                ...
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <form class="navbar-form navbar-left" role="search">
                            ...
                            <button type="button" class="btn btn-default search-movie-button" onclick="getMovieTrailer()">Search Movies</button>
                        </form>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body fnt-smaller">
                                ...
                                <h4 class="media-heading">
                                    <a href="#" class="movie-title movie-details-header" target="_self"></a></h4>
                                <label class="hidden-id-label"></label>
                                <p class="hidden-xs"></p>
                                <p><a href="#" class="btn btn-primary movie-detail-button" role="button">Get Movie Details</a> <a href="#" class="btn btn-primary movie-trailer-button" role="button">Watch All Trailers</a></p>
                            </div>
                        </div>
                    </div>
                </div>
